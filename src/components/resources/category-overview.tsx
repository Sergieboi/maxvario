...
const CATEGORY_SLUGS = [
  { key: "book",    slug: "books" },
  { key: "pdf",     slug: "pdfs" },
  { key: "podcast", slug: "podcasts" },
  { key: "youtube", slug: "youtube" },
  { key: "app",     slug: "apps" },
  { key: "course",  slug: "courses" },
] as const;
              ...
              >
                <div className="bg-blue-900 px-6 pt-8 pb-6 flex flex-col gap-8 relative overflow-hidden">
                  <p className="text-sm text-blue-300">
                    {count} {count !== 1 ? t("resourcePlural") : t("resourceSingular")}
                  </p>
