...
const RESOURCES: Resource[] = [
  ...
  {
    title: "100 Ways to Fly Better",
    author: "Bruce Goldsmith",
    description: "Practical tips from legendary paraglider designer Bruce Goldsmith — 100 concise lessons covering technique, safety, equipment, and mindset for pilots at every level.",
    category: "book",
    url: "#",
    free: false,
  },
